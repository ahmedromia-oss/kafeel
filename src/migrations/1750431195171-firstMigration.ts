...
export class FirstMigration1750431195171 implements MigrationInterface {
    name = 'FirstMigration1750431195171'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`chats\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` varchar(255) NOT NULL, \`lastMessageId\` varchar(255) NULL, UNIQUE INDEX \`REL_5768a56bdd855c5b78ce66c9a3\` (\`lastMessageId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`company\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(255) NOT NULL, \`aboutMe\` text NULL, \`companyName\` varchar(255) NULL, \`officePhoneNumber\` varchar(255) NULL, \`officialEmail\` varchar(255) NULL, \`websiteUrl\` varchar(255) NULL, \`officeCity\` varchar(255) NULL, \`commercialRegistrationNumber\` varchar(255) NULL, \`ownerName\` varchar(255) NULL, \`officeOwnerName\` varchar(255) NULL, \`licenseNumber\` varchar(100) NULL, \`officeName\` varchar(255) NULL, \`ownerPhone\` varchar(20) NULL, \`ownerEmail\` varchar(255) NULL, \`city\` varchar(100) NULL, \`licenseImage\` varchar(255) NULL, \`idImage\` varchar(255) NULL, PRIMARY KEY (\`userId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job_applicants\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`companyId\` varchar(255) NOT NULL, \`JobId\` varchar(255) NOT NULL, \`CV\` varchar(255) NOT NULL, \`describtion\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_e22011c8a786cd3fac74f41bff\` (\`userId\`, \`JobId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` varchar(255) NOT NULL, \`title\` varchar(255) NOT NULL, \`description\` text NOT NULL, \`salary\` decimal(10,2) NOT NULL, \`location\` varchar(255) NULL, \`jobType\` enum ('FULL_TIME', 'PART_TIME', 'TEMPORARY', 'INTERNSHIP') NOT NULL, \`isRemote\` tinyint NOT NULL DEFAULT 0, \`companyId\` varchar(255) NOT NULL, \`email\` text NOT NULL, \`currency\` text NOT NULL, \`phoneNumber\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_saved_job\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`jobId\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` varchar(255) NOT NULL, \`firstName\` varchar(255) NULL, \`lastName\` varchar(255) NULL, \`profilePhoto\` varchar(255) NULL, \`email\` varchar(255) NULL, \`password\` varchar(255) NOT NULL, \`emailVerified\` tinyint NOT NULL DEFAULT 0, \`phoneVerified\` tinyint NOT NULL DEFAULT 0, \`phoneNumber\` varchar(255) NULL, \`country\` varchar(255) NULL, \`birthDate\` datetime NULL, \`nationalId\` varchar(255) NULL, \`userType\` enum ('WORKER', 'KAFEEL', 'COMPANY', 'ADMIN') NOT NULL DEFAULT 'WORKER', \`userApproved\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), UNIQUE INDEX \`IDX_f2578043e491921209f5dadd08\` (\`phoneNumber\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_saved_advertise\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` int NOT NULL AUTO_INCREMENT, \`advertiseId\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`advertise\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`id\` varchar(255) NOT NULL, \`email\` varchar(100) NULL, \`phoneNumber\` varchar(100) NULL, \`userName\` varchar(100) NULL, \`jobTitle\` varchar(100) NOT NULL, \`currentCity\` varchar(50) NOT NULL, \`IsOpen\` tinyint NOT NULL DEFAULT 1, \`preferredSponsorType\` enum ('COMPANY', 'INDIVIDUAL', 'GOVERNMENT') NOT NULL, \`expectedNotificationTime\` varchar(50) NULL, \`workType\` enum ('FULL_TIME', 'PART_TIME', 'TEMPORARY', 'INTERNSHIP') NOT NULL, \`description\` text NULL, \`workerId\` varchar(255) NULL, \`companyId\` varchar(255) NULL, \`currencey\` text NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`worker\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(255) NOT NULL, \`jobTitle\` text NULL, \`aboutMe\` text NULL, \`cv\` text NULL, PRIMARY KEY (\`userId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_applicants\` ADD CONSTRAINT \`FK_acc4a197050d001cca0b5fc5f8c\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_saved_job\` ADD CONSTRAINT \`FK_38d632f7f59551af2891c0a62cf\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user_saved_job\` ADD CONSTRAINT \`FK_8911aad8686ac3cebc70aac330f\` FOREIGN KEY (\`jobId\`) REFERENCES \`job\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user_saved_advertise\` ADD CONSTRAINT \`FK_aea639bcaca1475035f4ce4f4e8\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user_saved_advertise\` ADD CONSTRAINT \`FK_e369e83a4d6e8016b30051ae60c\` FOREIGN KEY (\`advertiseId\`) REFERENCES \`advertise\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_saved_advertise\` DROP FOREIGN KEY \`FK_e369e83a4d6e8016b30051ae60c\``);
        await queryRunner.query(`ALTER TABLE \`user_saved_advertise\` DROP FOREIGN KEY \`FK_aea639bcaca1475035f4ce4f4e8\``);
        await queryRunner.query(`ALTER TABLE \`user_saved_job\` DROP FOREIGN KEY \`FK_8911aad8686ac3cebc70aac330f\``);
        await queryRunner.query(`ALTER TABLE \`user_saved_job\` DROP FOREIGN KEY \`FK_38d632f7f59551af2891c0a62cf\``);
        ...
        await queryRunner.query(`ALTER TABLE \`job_applicants\` DROP FOREIGN KEY \`FK_acc4a197050d001cca0b5fc5f8c\``);
        ...
        await queryRunner.query(`DROP TABLE \`user_saved_advertise\``);
        await queryRunner.query(`DROP INDEX \`IDX_f2578043e491921209f5dadd08\` ON \`user\``);
        await queryRunner.query(`DROP INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` ON \`user\``);
        await queryRunner.query(`DROP TABLE \`user\``);
        await queryRunner.query(`DROP TABLE \`user_saved_job\``);
        await queryRunner.query(`DROP TABLE \`job\``);
        await queryRunner.query(`DROP INDEX \`IDX_e22011c8a786cd3fac74f41bff\` ON \`job_applicants\``);
